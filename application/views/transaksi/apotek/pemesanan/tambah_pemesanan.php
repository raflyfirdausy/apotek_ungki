...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <form method="POST" action="<?= base_url("transaksi/apotek/pemesanan/tambah_proses") ?>" id="form_add" enctype='multipart/form-data'>
...
<script>
    ...
    $("#form_add").submit(e => {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url('transaksi/apotek/pemesanan/tambah_proses') ?>",
