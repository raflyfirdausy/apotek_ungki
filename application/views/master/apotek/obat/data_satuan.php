...
<div class="modal fade myModal" id="modal_tambah">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" id="form_add" action="<?= base_url("master/apotek/obat/satuan/add") ?>" enctype='multipart/form-data'>
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                <label for="recipient-name" class="control-label">Nama satuan Obat <span class="text-danger">*</span></label>
...
<div class="modal fade myModal" id="modal_edit">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" action="<?= base_url("master/apotek/obat/satuan/edit") ?>" id="form_edit" enctype='multipart/form-data'>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <label for="recipient-name" class="control-label">Nama satuan Obat <span class="text-danger">*</span></label>
...
<script>
    var table = $("#table_data").DataTable({
        ...
        "ajax": {
            "url": "<?= base_url("master/apotek/obat/satuan/get_data") ?>",
            "type": "POST"
        },
        "columns": [{
                "data": null,
    ...
    $("#form_add").submit(e => {
        ...
        $.ajax({
            type: "POST",
            dataType: "JSON",
            url: "<?= base_url("master/apotek/obat/satuan/add") ?>",
            data: data,
            processData: false,
            contentType: false,
            cache: false,
    ...
    $("#form_edit").submit(e => {
        ...
        $.ajax({
            type: "POST",
            dataType: "JSON",
            url: "<?= base_url("master/apotek/obat/satuan/edit") ?>",
            data: data,
            processData: false,
            contentType: false,
            cache: false,
    ...
    const modal_edit = (id) => {
        ...
        $.ajax({
            url: "<?= base_url('master/apotek/obat/satuan/get/') ?>" + id,
            type: "GET",
            dataType: "JSON",
    ...
    const hapus = (id) => {
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('master/apotek/obat/satuan/delete') ?>",
                    data: {
                        "id_data": id
                    },
                    dataType: "json",
