                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label text-right">Stok Awal <span class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <input required type="number" name="stok" class="form-control" placeholder="Stok Awal" value="">
                                    </div>
                                </div>
                                <div class="form-group row">
