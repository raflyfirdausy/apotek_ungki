        ...
        <div class="container-fluid">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <button type="button" class="btn btn-success float-right" data-toggle="modal" data-target="#modal_tambah"><i class="fas fa-plus"></i> Tambah Data Region</button>
                </div>
                <div class="card-body">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Form Tambah Region</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="POST" action="<?= base_url("master/region/add") ?>" id="form_add" enctype='multipart/form-data'>
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                <label for="recipient-name" class="control-label">Nama Region <span class="text-danger">*</span></label>
...
<div class="modal fade myModal" id="modal_edit">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Form Edit Region</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="POST" action="<?= base_url("master/region/edit") ?>" id="form_edit" enctype='multipart/form-data'>
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
...
<script>
    var table = $("#table_data").DataTable({
        ...
        "ajax": {
            "url": "<?= base_url("master/region/get_data") ?>",
            "type": "POST"
        },
        "columns": [{
                "data": null,
    ...
    $("#form_add").submit(e => {
        ...
        $.ajax({
            type: "POST",
            dataType: "JSON",
            url: "<?= base_url("master/region/add") ?>",
            data: data,
            processData: false,
            contentType: false,
            cache: false,
    ...
    const modal_edit = (id) => {
        ...
        $.ajax({
            url: "<?= base_url('master/region/get/') ?>" + id,
            type: "GET",
            dataType: "JSON",
    ...
    $("#form_edit").submit(e => {
        ...
        $.ajax({
            type: "POST",
            dataType: "JSON",
            url: "<?= base_url("master/region/edit") ?>",
            data: data,
            processData: false,
            contentType: false,
            cache: false,
    ...
    const hapus = (id) => {
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('master/region/delete') ?>",
                    data: {
                        "id_data": id
                    },
                    dataType: "json",
