        ...
        <div class="container-fluid">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <button type="button" class="btn btn-success float-right" data-toggle="modal" data-target="#modal_tambah"><i class="fas fa-plus"></i> Tambah Data Jenis APAR</button>
                </div>
                <div class="card-body">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Form Tambah Jenis APAR</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="POST" action="<?= base_url("master/jenis_apar/add") ?>" id="form_add" enctype='multipart/form-data'>
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                <label for="recipient-name" class="control-label">Nama Jenis APAR <span class="text-danger">*</span></label>
...
<div class="modal fade myModal" id="modal_edit">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Form Edit Jenis APAR</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="POST" action="<?= base_url("master/jenis_apar/edit") ?>" id="form_edit" enctype='multipart/form-data'>
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
...
<script>
    var table = $("#table_data").DataTable({
        ...
        "ajax": {
            "url": "<?= base_url("master/jenis_apar/get_data") ?>",
            "type": "POST"
        },
        "columns": [{
                "data": null,
    ...
    $("#form_add").submit(e => {
        ...
        $.ajax({
            type: "POST",
            dataType: "JSON",
            url: "<?= base_url("master/jenis_apar/add") ?>",
            data: data,
            processData: false,
            contentType: false,
            cache: false,
    ...
    const modal_edit = (id) => {
        ...
        $.ajax({
            url: "<?= base_url('master/jenis_apar/get/') ?>" + id,
            type: "GET",
            dataType: "JSON",
    ...
    $("#form_edit").submit(e => {
        ...
        $.ajax({
            type: "POST",
            dataType: "JSON",
            url: "<?= base_url("master/jenis_apar/edit") ?>",
            data: data,
            processData: false,
            contentType: false,
            cache: false,
    ...
    const hapus = (id) => {
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('master/jenis_apar/delete') ?>",
                    data: {
                        "id_data": id
                    },
                    dataType: "json",
