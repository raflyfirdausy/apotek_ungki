    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Form Tambah Perusahaan</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="POST" action="<?= base_url("master/perusahaan/add") ?>" id="form_add" enctype='multipart/form-data'>
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="recipient-name" class="control-label">Nama Perusahaan <span class="text-danger">*</span></label>
...
<div class="modal fade myModal" id="modal_edit">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Form Edit Perusahaan</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="POST" action="<?= base_url("master/perusahaan/edit") ?>" id="form_edit" enctype='multipart/form-data'>
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
...
<script>
    var table = $("#table_data").DataTable({
        ...
        "ajax": {
            "url": "<?= base_url("master/perusahaan/get_data") ?>",
            "type": "POST"
        },
        "columns": [{
                "data": null,
    ...
    $("#form_add").submit(e => {
        ...
        $.ajax({
            type: "POST",
            dataType: "JSON",
            url: "<?= base_url("master/perusahaan/add") ?>",
            data: data,
            processData: false,
            contentType: false,
            cache: false,
    ...
    const modal_edit = (id) => {
        ...
        $.ajax({
            url: "<?= base_url('master/perusahaan/get/') ?>" + id,
            type: "GET",
            dataType: "JSON",
    ...
    $("#form_edit").submit(e => {
        ...
        $.ajax({
            type: "POST",
            dataType: "JSON",
            url: "<?= base_url("master/perusahaan/edit") ?>",
            data: data,
            processData: false,
            contentType: false,
            cache: false,
    ...
    const hapus = (id) => {
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('master/perusahaan/delete') ?>",
                    data: {
                        "id_data": id
                    },
                    dataType: "json",
